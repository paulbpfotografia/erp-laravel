{{-- resources/views/modulos/productos/show.blade.php --}}
...
<div class="container mt-5">
  <div class="bg-white p-4 rounded shadow-sm border border-light-subtle">
    ...
    {{-- 1) Encabezado: Título + Volver + Acciones Opcionales --}}
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h4 class="text-primary-emphasis fw-semibold mb-0">
        <i class="bi bi-eye-fill me-2"></i> Detalle de Producto: {{ $product->name }}
      </h4>
      <div class="d-flex gap-2">
        ...
        <a href="{{ route('productos.edit', $product) }}" class="btn btn-warning">
    ...
    {{-- 2) Contenido en dos columnas: tabla de detalles + imagen --}}
    <div class="row g-4">
      <div class="col-lg-6">
        <div class="table-responsive">
          <table class="table table-borderless mb-0">
            <tbody>
              {{-- <tr><th class="fw-semibold w-25">ID</th><td>{{ $product->id }}</td></tr> --}}
